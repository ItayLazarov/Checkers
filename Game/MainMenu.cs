...
namespace Checkers.Game
{
    public class MainMenu
    {
        ...
        public static void Guide()
        {
            ...
            Console.WriteLine("3) Last Pawn - This pawn will appear on the board if you have left with only one pawn.\n");
            ...
            Console.WriteLine("if you selected an actual pawn on the board, the computer will let you to enter the numbers of the tile you want to move to.\n");

            Console.WriteLine("Otherwise, the computer will ask you again to enter a new location of an actual pawn on the board.\n");
            ...
            Console.WriteLine("Otherwise, you will keep eating as long there are rival pawns around you that can be eaten.\n");
